...
class AliExpressChatSession extends Model
{
    // Specify the table name to avoid snake_case conversion
    protected $table = 'aliexpress_chat_sessions';
    ...
    {
        return $this->hasMany(AliExpressChatMessage::class, 'session_id')->orderBy('order');
    }
