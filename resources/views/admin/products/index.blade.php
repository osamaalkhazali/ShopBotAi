...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <div class="p-4 bg-gray-50">
            <form action="{{ route('admin.products.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-3">
                <div>
                    <label for="title" class="block text-xs font-medium text-gray-700 mb-1">Title</label>
                    <input type="text" id="title" name="title" value="{{ request('title') }}" placeholder="Search title..." class="w-full">
                </div>
                ...
                <div>
                    ...
                    <input type="number" id="price_min" name="price_min" value="{{ request('price_min') }}" min="0" step="0.01" placeholder="Min price" class="w-full">
                </div>

                <div>
                    <label for="price_max" class="block text-xs font-medium text-gray-700 mb-1">Max Price</label>
                    <input type="number" id="price_max" name="price_max" value="{{ request('price_max') }}" min="0" step="0.01" placeholder="Max price" class="w-full">
                </div>
                ...
                <div class="flex items-end space-x-2">
                    ...
                    @if(request()->hasAny(['title', 'category_id', 'price_min', 'price_max', 'sort']))
